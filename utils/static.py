...
def compute_aec(input_data, sfreq, freq_range, tmp_dir):
    ...
    freq_range : list of int
        Lower and upper frequency bounds for filtering signals to calculate
        amplitude envelope.
    tmp_dir : str
    ...
    data = Data(input_data, store_dir=tmp_dir, sampling_frequency=sfreq)
    data.prepare(
        methods = {
